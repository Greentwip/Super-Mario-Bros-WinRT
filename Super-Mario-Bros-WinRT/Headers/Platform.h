...
// renamed due to conflict with WinRT Platform class
class GamePlatform
{
private:
...
public:
	GamePlatform(int iSize, int iType, int iXStart, int iXEnd, int iYStart, int iYEnd, float fXPos, float fYPos, bool direction, int seesawPlatformID = 0);
	~GamePlatform(void);
