...
void Map::loadLVL_1_2() {
	...
	vPlatform.push_back(new GamePlatform(6, 0, 139*32 + 16, 139*32 + 16, -32, CCFG::GAME_HEIGHT + 32, 139*32 + 16, 9*32 + 16, true));
	vPlatform.push_back(new GamePlatform(6, 0, 139*32 + 16, 139*32 + 16, -32, CCFG::GAME_HEIGHT + 32, 139*32 + 16, 1*32 + 16, true));

	vPlatform.push_back(new GamePlatform(6, 1, 154*32 + 16, 154*32 + 16, -32, CCFG::GAME_HEIGHT + 32, 154*32 + 16, 10*32, true));
	vPlatform.push_back(new GamePlatform(6, 1, 154*32 + 16, 154*32 + 16, -32, CCFG::GAME_HEIGHT + 32, 154*32 + 16, 2*32, true));
...
void Map::loadLVL_1_3() {
	...
	vPlatform.push_back(new GamePlatform(6, 2, 55*32, 55*32, CCFG::GAME_HEIGHT - 16 - 9*32, CCFG::GAME_HEIGHT - 32, 55*32, (float)CCFG::GAME_HEIGHT - 32, true));

	vPlatform.push_back(new GamePlatform(6, 3, 83*32 - 16, 86*32 + 16, CCFG::GAME_HEIGHT - 16 - 6*32, CCFG::GAME_HEIGHT - 16 - 6*32, 83*32 - 16, (float)CCFG::GAME_HEIGHT - 16 - 6*32, true));
	
	vPlatform.push_back(new GamePlatform(6, 3, 91*32 - 16, 93*32 + 16, CCFG::GAME_HEIGHT - 16 - 5*32, CCFG::GAME_HEIGHT - 16 - 5*32, 93*32 + 16, (float)CCFG::GAME_HEIGHT - 16 - 5*32, false));

	vPlatform.push_back(new GamePlatform(6, 3, 127*32 - 16, 131*32 + 16, CCFG::GAME_HEIGHT - 16 - 8*32, CCFG::GAME_HEIGHT - 16 - 8*32, 127*32 - 16, (float)CCFG::GAME_HEIGHT - 16 - 8*32, false));
...
void Map::loadLVL_1_4() {
	...
	vPlatform.push_back(new GamePlatform(4, 3, 136*32 - 16, 138*32 + 16, CCFG::GAME_HEIGHT - 16 - 8*32, CCFG::GAME_HEIGHT - 16 - 8*32, 136*32 - 16, (float)CCFG::GAME_HEIGHT - 16 - 8*32, false));
...
void Map::loadLVL_2_1() {
	...
	vPlatform.push_back(new GamePlatform(6, 4, 286*32 + 16, 335*32 + 16, CCFG::GAME_HEIGHT - 16 - 4*32, CCFG::GAME_HEIGHT - 16 - 4*32, 286*32.0f + 16, CCFG::GAME_HEIGHT - 16.0f - 4*32, true));
...
void Map::loadLVL_2_4() {
	...
	vPlatform.push_back(new GamePlatform(3, 1, 85*32 + 24, 85*32 + 16, -32, CCFG::GAME_HEIGHT + 32, 85*32 + 24, 9*32 + 16, true));
	vPlatform.push_back(new GamePlatform(3, 1, 85*32 + 24, 85*32 + 16, -32, CCFG::GAME_HEIGHT + 32, 85*32 + 24, 1*32 + 16, true));

	vPlatform.push_back(new GamePlatform(3, 0, 88*32 + 24, 88*32 + 16, -32, CCFG::GAME_HEIGHT + 32, 88*32 + 24, 10*32, true));
	vPlatform.push_back(new GamePlatform(3, 0, 88*32 + 24, 88*32 + 16, -32, CCFG::GAME_HEIGHT + 32, 88*32 + 24, 2*32, true));
...
void Map::loadLVL_3_1() {
	...
	vPlatform.push_back(new GamePlatform(6, 4, 286*32 + 16, 355*32 + 16, CCFG::GAME_HEIGHT - 16 - 4*32, CCFG::GAME_HEIGHT - 16 - 4*32, 286*32.0f + 16, CCFG::GAME_HEIGHT - 16.0f - 4*32, true));
...
void Map::loadLVL_3_3() {
	...
	vPlatform.push_back(new GamePlatform(6, 6, 81*32, 81*32, CCFG::GAME_HEIGHT - 16, CCFG::GAME_HEIGHT - 16 - 11*32, 81*32, (float)CCFG::GAME_HEIGHT - 16 - 8*32, true, 1));
	vPlatform.push_back(new GamePlatform(6, 6, 88*32, 88*32, CCFG::GAME_HEIGHT - 16, CCFG::GAME_HEIGHT - 16 - 11*32, 88*32, (float)CCFG::GAME_HEIGHT - 16 - 6*32, true, 0));

	structSeeSaw(137, 12, 5);
	vPlatform.push_back(new GamePlatform(6, 6, 136*32, 136*32, CCFG::GAME_HEIGHT - 16, CCFG::GAME_HEIGHT - 16 - 11*32, 136*32, (float)CCFG::GAME_HEIGHT - 16 - 9*32, true, 3));
	vPlatform.push_back(new GamePlatform(6, 6, 140*32, 140*32, CCFG::GAME_HEIGHT - 16, CCFG::GAME_HEIGHT - 16 - 11*32, 140*32, (float)CCFG::GAME_HEIGHT - 16 - 6*32, true, 2));
	// -- SEESAW

	vPlatform.push_back(new GamePlatform(6, 3, 27*32 - 16, 30*32 + 16, CCFG::GAME_HEIGHT - 16 - 10*32, CCFG::GAME_HEIGHT - 16 - 10*32, 27*32 - 16, (float)CCFG::GAME_HEIGHT - 16 - 10*32, false));
	vPlatform.push_back(new GamePlatform(6, 3, 30*32 - 16, 33*32 + 16, CCFG::GAME_HEIGHT - 16 - 6*32, CCFG::GAME_HEIGHT - 16 - 6*32, 33*32 + 16, (float)CCFG::GAME_HEIGHT - 16 - 6*32, true));
	vPlatform.push_back(new GamePlatform(6, 3, 91*32 - 32, 94*32, CCFG::GAME_HEIGHT - 16 - 5*32, CCFG::GAME_HEIGHT - 16 - 5*32, 94*32, (float)CCFG::GAME_HEIGHT - 16 - 5*32, true));
	vPlatform.push_back(new GamePlatform(6, 3, 92*32, 96*32, CCFG::GAME_HEIGHT - 16 - 9*32, CCFG::GAME_HEIGHT - 16 - 9*32, 92*32, (float)CCFG::GAME_HEIGHT - 16 - 9*32, false));
	vPlatform.push_back(new GamePlatform(6, 3, 100*32 - 16, 103*32 + 16, CCFG::GAME_HEIGHT - 16 - 3*32, CCFG::GAME_HEIGHT - 16 - 3*32, 103*32 + 16, (float)CCFG::GAME_HEIGHT - 16 - 3*32, true));
	vPlatform.push_back(new GamePlatform(6, 3, 129*32 - 16, 132*32 + 16, CCFG::GAME_HEIGHT - 16 - 8*32, CCFG::GAME_HEIGHT - 16 - 8*32, 132*32 + 16, (float)CCFG::GAME_HEIGHT - 16 - 8*32, true));

	vPlatform.push_back(new GamePlatform(6, 5, 60*32, 60*32, CCFG::GAME_HEIGHT - 16 - 8*32, CCFG::GAME_HEIGHT - 16 - 8*32, 60*32, (float)CCFG::GAME_HEIGHT - 16 - 8*32, true));
...
void Map::loadLVL_4_2() {
	...
	vPlatform.push_back(new GamePlatform(6, 0, 58*32 + 16, 58*32 + 16, -32, CCFG::GAME_HEIGHT + 32, 58*32 + 16, 9*32 + 16, true));
	vPlatform.push_back(new GamePlatform(6, 0, 58*32 + 16, 58*32 + 16, -32, CCFG::GAME_HEIGHT + 32, 58*32 + 16, 1*32 + 16, true));

	vPlatform.push_back(new GamePlatform(6, 0, 114*32 + 16, 114*32 + 16, -32, CCFG::GAME_HEIGHT + 32, 114*32 + 16, 9*32 + 16, true));
	vPlatform.push_back(new GamePlatform(6, 0, 114*32 + 16, 114*32 + 16, -32, CCFG::GAME_HEIGHT + 32, 114*32 + 16, 1*32 + 16, true));

	vPlatform.push_back(new GamePlatform(6, 1, 124*32, 124*32, -32, CCFG::GAME_HEIGHT + 32, 124*32, 10*32, true));
	vPlatform.push_back(new GamePlatform(6, 1, 124*32, 124*32, -32, CCFG::GAME_HEIGHT + 32, 124*32, 2*32, true));

	vPlatform.push_back(new GamePlatform(6, 0, 156*32, 156*32, -32, CCFG::GAME_HEIGHT + 32, 156*32, 9*32 + 16, true));
	vPlatform.push_back(new GamePlatform(6, 0, 156*32, 156*32, -32, CCFG::GAME_HEIGHT + 32, 156*32, 1*32 + 16, true));
...
void Map::loadLVL_4_3() {
	...
	vPlatform.push_back(new GamePlatform(6, 6, 48*32, 48*32, CCFG::GAME_HEIGHT - 16, CCFG::GAME_HEIGHT - 16 - 11*32, 48*32, (float)CCFG::GAME_HEIGHT - 16 - 9*32, true, 1));
	vPlatform.push_back(new GamePlatform(6, 6, 55*32, 55*32, CCFG::GAME_HEIGHT - 16, CCFG::GAME_HEIGHT - 16 - 11*32, 55*32, (float)CCFG::GAME_HEIGHT - 16 - 6*32, true, 0));

	structSeeSaw(81, 12, 9);
	vPlatform.push_back(new GamePlatform(6, 6, 80*32, 80*32, CCFG::GAME_HEIGHT - 16, CCFG::GAME_HEIGHT - 16 - 11*32, 80*32, (float)CCFG::GAME_HEIGHT - 16 - 9*32, true, 3));
	vPlatform.push_back(new GamePlatform(6, 6, 88*32, 88*32, CCFG::GAME_HEIGHT - 16, CCFG::GAME_HEIGHT - 16 - 11*32, 88*32, (float)CCFG::GAME_HEIGHT - 16 - 5*32, true, 2));

	structSeeSaw(92, 12, 6);
	vPlatform.push_back(new GamePlatform(6, 6, 91*32, 91*32, CCFG::GAME_HEIGHT - 16, CCFG::GAME_HEIGHT - 16 - 11*32, 91*32, (float)CCFG::GAME_HEIGHT - 16 - 9*32, true, 5));
	vPlatform.push_back(new GamePlatform(6, 6, 96*32, 96*32, CCFG::GAME_HEIGHT - 16, CCFG::GAME_HEIGHT - 16 - 11*32, 96*32, (float)CCFG::GAME_HEIGHT - 16 - 5*32, true, 4));
	
	structSeeSaw(103, 12, 7);
	vPlatform.push_back(new GamePlatform(6, 6, 102*32, 102*32, CCFG::GAME_HEIGHT - 16, CCFG::GAME_HEIGHT - 16 - 11*32, 102*32, (float)CCFG::GAME_HEIGHT - 16 - 9*32, true, 7));
	vPlatform.push_back(new GamePlatform(6, 6, 108*32, 108*32, CCFG::GAME_HEIGHT - 16, CCFG::GAME_HEIGHT - 16 - 11*32, 108*32, (float)CCFG::GAME_HEIGHT - 16 - 5*32, true, 6));
	// -- SEESAW

	vPlatform.push_back(new GamePlatform(6, 2, 58*32, 58*32, CCFG::GAME_HEIGHT - 16 - 10*32, CCFG::GAME_HEIGHT - 64, 58*32, (float)CCFG::GAME_HEIGHT - 64, true));
	vPlatform.push_back(new GamePlatform(6, 2, 62*32, 62*32, CCFG::GAME_HEIGHT - 12*32, CCFG::GAME_HEIGHT - 128, 62*32, (float)CCFG::GAME_HEIGHT - 12*32, false));
	vPlatform.push_back(new GamePlatform(6, 2, 136*32, 136*32, CCFG::GAME_HEIGHT - 16 - 9*32, CCFG::GAME_HEIGHT - 48, 136*32, (float)CCFG::GAME_HEIGHT - 6*32, false));
...
void Map::loadLVL_5_2() {
	...
	vPlatform.push_back(new GamePlatform(6, 2, 22*32, 22*32, CCFG::GAME_HEIGHT - 12*32, CCFG::GAME_HEIGHT - 16 - 3*32, 22*32 + 16, (float)CCFG::GAME_HEIGHT - 16 - 4*32, true));
	vPlatform.push_back(new GamePlatform(6, 2, 28*32, 28*32, CCFG::GAME_HEIGHT - 12*32, CCFG::GAME_HEIGHT - 16 - 3*32, 28*32 + 16, (float)CCFG::GAME_HEIGHT - 12*32, false));
	...
	vPlatform.push_back(new GamePlatform(6, 4, 341*32 + 16, 390*32 + 16, CCFG::GAME_HEIGHT - 16 - 4*32, CCFG::GAME_HEIGHT - 16 - 4*32, 341*32.0f + 16, CCFG::GAME_HEIGHT - 16.0f - 4*32, true));
}
...
void Map::loadLVL_5_3() {
	...
	vPlatform.push_back(new GamePlatform(4, 2, 55*32, 55*32, CCFG::GAME_HEIGHT - 16 - 9*32, CCFG::GAME_HEIGHT - 32, 55*32, (float)CCFG::GAME_HEIGHT - 32, true));

	vPlatform.push_back(new GamePlatform(4, 3, 83*32 - 16, 86*32 + 16, CCFG::GAME_HEIGHT - 16 - 6*32, CCFG::GAME_HEIGHT - 16 - 6*32, 83*32 - 16, (float)CCFG::GAME_HEIGHT - 16 - 6*32, true));
	
	vPlatform.push_back(new GamePlatform(4, 3, 91*32 - 16, 93*32 + 16, CCFG::GAME_HEIGHT - 16 - 5*32, CCFG::GAME_HEIGHT - 16 - 5*32, 93*32 + 16, (float)CCFG::GAME_HEIGHT - 16 - 5*32, false));

	vPlatform.push_back(new GamePlatform(4, 3, 127*32 - 16, 131*32 + 16, CCFG::GAME_HEIGHT - 16 - 8*32, CCFG::GAME_HEIGHT - 16 - 8*32, 127*32 - 16, (float)CCFG::GAME_HEIGHT - 16 - 8*32, false));
...
void Map::loadLVL_6_2() {
	...
	vPlatform.push_back(new GamePlatform(4, 2, 22*32, 22*32, CCFG::GAME_HEIGHT - 12*32, CCFG::GAME_HEIGHT - 16 - 3*32, 22*32 + 16, (float)CCFG::GAME_HEIGHT - 16 - 4*32, true));
	vPlatform.push_back(new GamePlatform(4, 2, 28*32, 28*32, CCFG::GAME_HEIGHT - 12*32, CCFG::GAME_HEIGHT - 16 - 3*32, 28*32 + 16, (float)CCFG::GAME_HEIGHT - 12*32, false));
	...
	vPlatform.push_back(new GamePlatform(6, 4, 406*32 + 16, 475*32 + 16, CCFG::GAME_HEIGHT - 16 - 4*32, CCFG::GAME_HEIGHT - 16 - 4*32, 406*32.0f + 16, CCFG::GAME_HEIGHT - 16.0f - 4*32, true));
...
void Map::loadLVL_6_3() {
	...
	vPlatform.push_back(new GamePlatform(4, 6, 70*32 + 16, 70*32 + 16, CCFG::GAME_HEIGHT - 16, CCFG::GAME_HEIGHT - 16 - 11*32, 70*32 + 16, (float)CCFG::GAME_HEIGHT - 16 - 9*32, true, 1));
	vPlatform.push_back(new GamePlatform(4, 6, 74*32 + 16, 74*32 + 16, CCFG::GAME_HEIGHT - 16, CCFG::GAME_HEIGHT - 16 - 11*32, 74*32 + 16, (float)CCFG::GAME_HEIGHT - 16 - 5*32, true, 0));

	structSeeSaw(79, 12, 4);
	
	vPlatform.push_back(new GamePlatform(4, 6, 78*32 + 16, 78*32 + 16, CCFG::GAME_HEIGHT - 16, CCFG::GAME_HEIGHT - 16 - 11*32, 78*32 + 16, (float)CCFG::GAME_HEIGHT - 16 - 9*32, true, 3));
	vPlatform.push_back(new GamePlatform(4, 6, 81*32 + 16, 81*32 + 16, CCFG::GAME_HEIGHT - 16, CCFG::GAME_HEIGHT - 16 - 11*32, 81*32 + 16, (float)CCFG::GAME_HEIGHT - 16 - 5*32, true, 2));

	structSeeSaw(127, 12, 4);
	
	vPlatform.push_back(new GamePlatform(4, 6, 126*32 + 16, 126*32 + 16, CCFG::GAME_HEIGHT - 16, CCFG::GAME_HEIGHT - 16 - 11*32, 126*32 + 16, (float)CCFG::GAME_HEIGHT - 16 - 9*32, true, 5));
	vPlatform.push_back(new GamePlatform(4, 6, 129*32 + 16, 129*32 + 16, CCFG::GAME_HEIGHT - 16, CCFG::GAME_HEIGHT - 16 - 11*32, 129*32 + 16, (float)CCFG::GAME_HEIGHT - 16 - 5*32, true, 4));

	// -- SEESAW

	vPlatform.push_back(new GamePlatform(4, 2, 28*32, 28*32, CCFG::GAME_HEIGHT - 11*32, CCFG::GAME_HEIGHT - 16 - 2*32, 28*32, (float)CCFG::GAME_HEIGHT - 12*32, false));

	vPlatform.push_back(new GamePlatform(4, 3, 39*32 + 16, 45*32 + 16, CCFG::GAME_HEIGHT - 9*32, CCFG::GAME_HEIGHT - 16 - 9*32, 39*32 + 16, (float)CCFG::GAME_HEIGHT - 9*32, false));
	vPlatform.push_back(new GamePlatform(4, 3, 45*32 + 16, 49*32 + 16, CCFG::GAME_HEIGHT - 7*32, CCFG::GAME_HEIGHT - 16 - 7*32, 45*32 + 16, (float)CCFG::GAME_HEIGHT - 7*32, true));
	vPlatform.push_back(new GamePlatform(4, 3, 51*32, 56*32, CCFG::GAME_HEIGHT - 8*32, CCFG::GAME_HEIGHT - 16 - 8*32, 51*32 + 16, (float)CCFG::GAME_HEIGHT - 8*32, false));
	
	vPlatform.push_back(new GamePlatform(4, 2, 60*32, 60*32, CCFG::GAME_HEIGHT - 11*32, CCFG::GAME_HEIGHT - 16 - 2*32, 60*32, (float)CCFG::GAME_HEIGHT - 12*32, false));
	vPlatform.push_back(new GamePlatform(4, 2, 121*32 + 16, 121*32 + 16, CCFG::GAME_HEIGHT - 11*32, CCFG::GAME_HEIGHT - 16 - 2*32, 121*32 + 16, (float)CCFG::GAME_HEIGHT - 12*32, false));

	vPlatform.push_back(new GamePlatform(4, 5, 141*32, 141*32, CCFG::GAME_HEIGHT - 16 - 7*32, CCFG::GAME_HEIGHT - 16 - 7*32, 141*32, (float)CCFG::GAME_HEIGHT - 16 - 7*32, true));
	vPlatform.push_back(new GamePlatform(4, 5, 145*32, 145*32, CCFG::GAME_HEIGHT - 16 - 8*32, CCFG::GAME_HEIGHT - 16 - 8*32, 145*32, (float)CCFG::GAME_HEIGHT - 16 - 8*32, true));
	vPlatform.push_back(new GamePlatform(4, 5, 149*32, 149*32, CCFG::GAME_HEIGHT - 16 - 6*32, CCFG::GAME_HEIGHT - 16 - 6*32, 149*32, (float)CCFG::GAME_HEIGHT - 16 - 6*32, true));
	vPlatform.push_back(new GamePlatform(4, 5, 153*32, 153*32, CCFG::GAME_HEIGHT - 16 - 7*32, CCFG::GAME_HEIGHT - 16 - 7*32, 153*32, (float)CCFG::GAME_HEIGHT - 16 - 7*32, true));
...
void Map::loadLVL_7_4() {
	...
	vPlatform.push_back(new GamePlatform(4, 5, 18*32, 18*32, CCFG::GAME_HEIGHT - 16 - 7*32, CCFG::GAME_HEIGHT - 16 - 7*32, 18*32, (float)CCFG::GAME_HEIGHT - 16 - 7*32, true));
	vPlatform.push_back(new GamePlatform(4, 5, 22*32, 22*32, CCFG::GAME_HEIGHT - 16 - 6*32, CCFG::GAME_HEIGHT - 16 - 6*32, 22*32, (float)CCFG::GAME_HEIGHT - 16 - 6*32, true));
...
void Map::loadLVL_8_4() {
	...
	vPlatform.push_back(new GamePlatform(4, 3, 68*32 - 16, 71*32 + 16, CCFG::GAME_HEIGHT - 16 - 32, CCFG::GAME_HEIGHT - 16 - 32, 68*32 - 16, (float)CCFG::GAME_HEIGHT - 16 - 30, true));
...
GamePlatform* Map::getPlatform(int iID) {
