...
CCore::CCore(void) {
	...
	window = SDL_CreateWindow("Super Mario Bros. 8.1", 
...
void CCore::mainLoop() {
	...
	while(!quitGame && mainEvent->type != SDL_QUIT) {
		...
		rect.w = CCFG::GAME_WIDTH;
		rect.h = CCFG::GAME_HEIGHT;
