...
void AboutMenu::Draw(SDL_Renderer* rR) {
	CCFG::getText()->DrawWS(rR, "SUPER MARIO BROS.", 150, 128, 0, 0, 0);

	CCFG::getText()->DrawWS(rR, "DEVELOPER: LUKASZ JAKOWSKI", 150, 150, 0, 0, 0);
	CCFG::getText()->DrawWS(rR, "DEVELOPER: VICTOR LOPEZ", 150, 170, 0, 0, 0);
	
	CCFG::getText()->DrawWS(rR, "WWW.GREENTWIP.COM", 150, 224, 0, 0, 0);
